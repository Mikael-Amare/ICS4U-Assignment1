...
265 FOR P = 1 TO 5
270 LET U(P) = 0
280 LET VCP = 0 ' Assumed variable initialization
285 LET TCP = T(P) - 10
290 NEXT P
295 LET V(3) = 1
300 PRINT
...
310 PRINT
315 PRINT "WAGER"
320 LET P = 1 ' Assumed variable assignment
325 INPUT W
330 LET W(2) = W
335 IF W > 500 THEN GOTO 360
340 IF W = 777 THEN GOTO 380
345 GOTO 355
350 GOSUB 145
355 GOTO 315
